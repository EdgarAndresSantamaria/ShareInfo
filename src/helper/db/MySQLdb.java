...
public class MySQLdb {
    ...
    private String passwd = "MrJesucristo97";
	...
	public void updatepUsr(String email,String contrasena, String username) {
		String update = "update shareinfo.users set password='"+contrasena+ "' WHERE email='" + email + "' AND username='" + username + "';";
		System.out.println("     DB query: " + update);
    	try {
	    	Statement st = this.conn.createStatement();
	...
	public void dropMsg(String username) {
		String delete = "Delete FROM shareinfo.messages WHERE username='" + username + "';";
		System.out.println("     DB query: " + delete);
    	try {
	    	Statement st = this.conn.createStatement();
